...
public class DebtDashboardController {
    ...
    @GetMapping("/nseDashboard/reports/general/adequacy")
    public ResponseEntity<AdequacyFullReport> getAdequacyReport(@RequestHeader Map<String, String> header,
                                                               @RequestBody GeneralReportRequest reportRequest){
        return this.debtDashboardService.getGeneralReport(header, reportRequest);
    }

    @GetMapping("/nseDashboard/reports/general/exceptional")
    ...
    @GetMapping("/nseDashboard/reports/general/soft-mail")
    ...
    @GetMapping("/nseDashboard/reports/general/non-compliant")
    ...
    @GetMapping("/nseDashboard/reports/general/internal")
    ...
    @GetMapping("/nseDashboard/reports/general/wrong-subject")
    ...
    @GetMapping("/nseDashboard/reports/general/clarification")
    ...
    @GetMapping("/nseDashboard/reports/general/announcement")
    ...
    @GetMapping("/nseDashboard/report/general/auto-email")
